...
namespace Pelotas
{
    public partial class Pelotas : Form
    {
        ...
        Image particleImage = Resources.PngItem_5094082;
        ...
        public void Init()
        {
            ...
            backgroundImage = new Bitmap(Resources.desktop_wallpaper_3d_landscape_3d_landscape_dragon_ball_scenery);
            emisorImage = new Bitmap(Resources.Vegeta_Ultra_Ego);
        ...
        private void TIMER_Tick(object sender, EventArgs e)
        {
            ...
            //g.DrawImage(emisorImage, 550, 535, 270, 270);
